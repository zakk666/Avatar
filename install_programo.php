...
$step_one = "<h2>Program-O Chatbot Installer</h2>
...
<p>Installation complete please test ur bot then do the following:
						...
						<p><a href=\"admin/install_myprogramo.php\">To install My Program-O admin area</a></p>
...
<title>Program-o Chatbot Installer</title>
</head><body>
<?php
if(isset($_GET['step']))
{
...
else
{
	...
	switch($step)
	{
		case '1':
			echo $step_one;
			echo "<h2>Do not run this installer if you are upgrading your Program-O version.<br/>This will wipe reset your database and you will lose all your exisiting bot brain, personality and settings.<br>DELETE THIS SCRIPT TO PREVENT MALICIOUS RESETS FROM NASTY PEOPLE</h2>";
			break;
		case '2':
			echo $step_two;
			createTables();
