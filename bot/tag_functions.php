...
function closeSystem($response_Array)
{
	...
	//debug
	runDebug($response_Array,3,"closeSystem","<br>Array Name = ".$response_Array['rname']."<br>".htmlentities($tmp));
	$cmd = explode(" ", $tmp);
	...
	//debug
	runDebug($response_Array,3,"closeSystem","<br>Array Name = ".$response_Array['rname']."<br>".htmlentities($output));
	//return
...
function isHTML($response_Array)
{
	...
	runDebug($response_Array,3,"HTMLTag","<br>Array Name = ".$response_Array['rname']."<br>Parsed: ".htmlentities($html));
	return $response_Array;
}
//--------------------------------------------------------------
...
function closeJavascript($response_Array,$tag)
{
	...
	//debug	
	runDebug($response_Array,3,"close$tag","<br>Array Name = ".$response_Array['rname']."<br>".htmlentities($tmp));
	//return	
	return $response_Array;
}
...
function abbreviations($response_Array)
{
	...
	$tmpmo = htmlentities($matchedOutput);
	//make replacements
