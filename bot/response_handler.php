...
/**
 * Where the personality join the game.
 * 
...
//	And this is where the hidden parts of the form come from.
//	In this way, we can save data inside of the html source. But not database.
//	Maybe useful if we can find a way to save the data to the database.
//-----------------------------------------------------------------------------------------------
